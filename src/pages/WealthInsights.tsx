...
export default function WealthInsights() {
  const insights = [
    ...
    },
    {
      ...
      color: "bg-copper-50 text-copper-600"
    }
  ];
  ...
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-copper-600 font-bold uppercase tracking-[0.3em] text-[10px] mb-4 block">Intelligence</span>
          <h1 className="text-5xl md:text-6xl font-serif font-medium text-[#0a192f] mb-6">Wealth Insights</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {insights.map((item, i) => (
            <motion.div
              ...
              className="p-10 rounded-[2.5rem] bg-white border border-copper-100 shadow-xl shadow-copper-900/5 hover:border-copper-400 transition-all duration-500 group"
            >
              ...
              <h3 className="text-2xl font-serif font-bold text-[#0a192f] mb-4">{item.title}</h3>
              <p className="text-gray-500 font-light leading-relaxed mb-8">{item.desc}</p>
              <button className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-copper-600 hover:text-copper-700 transition-colors">
        ...
        >
          <div className="absolute top-0 right-0 w-1/2 h-full bg-copper-500/10 blur-[120px] rounded-full translate-x-1/4" />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 text-copper-500 mb-6">
                <Zap className="w-5 h-5 fill-current" />
                <span className="text-xs font-bold uppercase tracking-widest">Premium Strategy</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-serif font-medium mb-6 leading-tight">The Geo-Arbitrage <br /><span className="text-copper-500 italic">Masterclass</span></h2>
              ...
              <button className="px-10 py-5 rounded-2xl bg-copper-500 text-white font-bold hover:bg-copper-600 transition-all active:scale-95 shadow-xl shadow-copper-900/20">
                Unlock Full Guide
              </button>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm">
                <BarChart3 className="w-8 h-8 text-[#b87333] mb-4" />
                <div className="text-2xl font-serif font-bold mb-1">12%</div>
              ...
              <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm mt-8">
                <Coins className="w-8 h-8 text-[#b87333] mb-4" />
                <div className="text-2xl font-serif font-bold mb-1">4.5x</div>
