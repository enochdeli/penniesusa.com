  ...
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-gold-600 font-bold uppercase tracking-[0.3em] text-[10px] mb-4 block">Intelligence</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {insights.map((item, i) => (
            <motion.div
              ...
              className="p-10 rounded-[2.5rem] bg-white border border-gold-100 shadow-xl shadow-gold-900/5 hover:border-gold-400 transition-all duration-500 group"
            >
              ...
              <button className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gold-600 hover:text-gold-700 transition-colors">
        ...
        >
          <div className="absolute top-0 right-0 w-1/2 h-full bg-gold-500/10 blur-[120px] rounded-full translate-x-1/4" />
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-medium mb-6 leading-tight">The Geo-Arbitrage <br /><span className="text-gold-500 italic">Masterclass</span></h2>
              ...
              <button className="px-10 py-5 rounded-2xl bg-gold-500 text-white font-bold hover:bg-gold-600 transition-all active:scale-95 shadow-xl shadow-gold-900/20">
                Unlock Full Guide
              </button>
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm mt-8">
                <Coins className="w-8 h-8 text-gold-500 mb-4" />
