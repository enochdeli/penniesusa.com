                    ...
                    {isCurrencyDropdownOpen && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute right-0 mt-2 w-64 max-h-80 overflow-hidden bg-white rounded-xl shadow-2xl border border-gray-100 z-50 flex flex-col"
                        >
                          <div className="p-2 border-b border-gray-100 sticky top-0 bg-white z-10">
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="w-full pl-9 pr-3 py-2 bg-gray-50 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-copper-200"
                                autoFocus
                              />
                            </div>
                          </div>
                            ...
                            {filteredCurrencies.length > 0 ? (
                              filteredCurrencies.map((c) => (
                                <button
                                  ...
                                  className={cn(
                                    "w-full flex items-center justify-between p-3 rounded-lg transition-colors text-left mb-1 last:mb-0",
                                    baseCurrencyCode === c.code ? "bg-copper-50 text-copper-700" : "hover:bg-gray-50"
                                  )}
                                >
                                  ...
                                  {baseCurrencyCode === c.code && <div className="w-2 h-2 rounded-full bg-copper-500" />}
                                </button>
                              ))
                            ) : (
